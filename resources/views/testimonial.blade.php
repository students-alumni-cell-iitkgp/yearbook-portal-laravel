                  ...
                  <li class="notification-box">
                    <div class="row">
                      ...
                      <div class="col-lg-3 col-sm-3 col-3 text-center">
                        <img src="{{ url('../{{$pic[0]}}') }}" class="w-50 rounded-circle">
                      </div> 
                ...
                <span class="section-heading-lower"><div class="col-md-7">
                  <div class="well well-sm">
                    ...
                    <div class="row" id="post-review-box" style="display:none;">
                      <div class="col-md-12">
                        <form action="{{ url('/writetestimony/{{$data['rollno']}}') }}" onSubmit="alert('Your views will be added in his yearbook after his registration and approval');" method="POST" style="padding-top: 0;">
                          {{csrf_field()}}
